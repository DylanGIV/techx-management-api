...
{
    public partial class correctteam_project : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_Accounts_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountCompany", x => new { x.CompaniesId, x.EmployeesId });
                    table.ForeignKey(
                        name: "FK_AccountCompany_Accounts_EmployeesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountTeam", x => new { x.EmployeesId, x.TeamsId });
                    table.ForeignKey(
                        name: "FK_AccountTeam_Accounts_EmployeesId",
                        column: x => x.EmployeesId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountTeam_Teams_TeamsId",
                        column: x => x.TeamsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountCompany_EmployeesId",
                table: "AccountCompany",
                column: "EmployeesId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountTeam_TeamsId",
                table: "AccountTeam",
                column: "TeamsId");
